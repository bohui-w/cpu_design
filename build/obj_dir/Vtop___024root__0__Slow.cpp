...
VL_ATTR_COLD void Vtop___024root___eval_static(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__sel__0 = vlSelfRef.sel;
}
            ...
            if ((1ULL & vlSelfRef.__VstlTriggered[0U])) {
                {
                    ...
                    vlSelfRef.Q = 0U;
                    if ((1U & (~ (IData)(vlSelfRef.sel)))) {
                        vlSelfRef.Q = (0x0000000fU 
                                       & (IData)(vlSelfRef.D));
                    }
                    if (vlSelfRef.sel) {
                        vlSelfRef.Q = (0x0000000fU 
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__ico(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)((triggers[0U] >> 2U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 2 is active: @( D)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 3U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 3 is active: @( sel)\n");
    }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__sel__0 = 0;
